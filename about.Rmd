...
List of available market + currency pairs in terms of pre/post processing API interface (dictionary can be extended by user via options). All currency pairs and methods available for supported markets but with no translation.
```{r}
